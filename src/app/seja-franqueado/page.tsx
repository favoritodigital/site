...
export default function FranchiseeLandingPage() {
  return (
    <div>
      ...
      <section className='from-primaryDark-10 to-primaryLight-10 bg-gradient-to-tr p-10'>
      ...
      <section className='from-primaryDark-10 to-primaryLight-10 flex w-full flex-col gap-6 bg-gradient-to-tr p-10 pb-20'>
        <h2 className='text-center text-3xl'>
          Nossos depoimentos{' '}
          <span className='bg-gradient-to-tr from-primaryDark-400 to-primaryLight-400 bg-clip-text font-semibold text-transparent'>
            Favoritos
